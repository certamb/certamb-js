                ...
                req.onreadystatechange = function () {
                    if (req.readyState == 4) {
                        if (req.status == 200) {
                            ...
                            kc.serverUrl = config['server-url'];
                            kc.username = config['username'];
                            kc.sucursal = config['sucursal'];
                            kc.agencia = config['agencia'];
                            kc.token = config['token'];
